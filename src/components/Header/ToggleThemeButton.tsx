import { Button, theme, useBreakpointValue, useColorMode } from "@chakra-ui/react"
...
export function ToggleThemeButton() {
    ...
    return (
        <Button
          ...
          color={!isWideVersion && "gray.200"}
          border={!isWideVersion && "2px"}
        >
          <svg
            width='35'
            height='35'
          ...
          >
            ...
            <path
              ...
              fill={colorMode == 'dark' ? colors.transparent : colors.yellow[200]}
            />
            <path
              fillRule='evenodd'
              clipRule='evenodd'
              ...
              fill={colorMode == 'dark' ? colors.gray[200] : colors.yellow[100]}
            />
          </svg>
        </Button>
    )
